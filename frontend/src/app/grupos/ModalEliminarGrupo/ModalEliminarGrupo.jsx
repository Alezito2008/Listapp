...
export default function ModalEliminarGrupo({callback}){
    return(
        <>
        ...
        <div className="flex justify-center items-center size-full text-[#0C0563]">
            <div className="flex justify-around items-center bg-white flex-col z-10 rounded-2xl w-96 h-60 gap-12">
                    ...
                    <div className="flex flex-row gap-10">    
                        ...
                        <button type="button" onClick={callback} className="flex justify-center items-center rounded-xl bg-[#0C0563] text-white h-6 px-6 py-4">Eliminar</button>
                    </div>
            </div>
        </div>
